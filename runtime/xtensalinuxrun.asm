...
#define system_call
	...
	.code #0
		movi	a2, #1
		j	@_system_call_wrapper#2

#enddef

	system_call	sys_brk, 83, 1
	system_call	sys_clock_getres, 406, 2
	system_call	sys_clock_gettime, 403, 2
	system_call	sys_clone, 116, 5
	system_call	sys_close, 9, 1
	system_call	sys_exit, 118, 1
	system_call	sys_exit_group, 119, 1
	system_call	sys_futex, 422, 6
	system_call	sys_getpid, 120, 0
	system_call	sys_gettid, 127, 0
	system_call	sys_lseek, 15, 3
	system_call	sys_nanosleep, 195, 2
	system_call	sys_open, 8, 3
	system_call	sys_read, 12, 3
	system_call	sys_rename, 33, 2
	system_call	sys_sched_getaffinity, 157, 3
	system_call	sys_sched_setaffinity, 156, 3
	system_call	sys_time, 154, 1
	system_call	sys_times, 154, 1
	system_call	sys_unlink, 38, 1
	system_call	sys_waitid, 122, 5
	system_call	sys_write, 13, 3
