...
#ifndef ECS_POWERPC_ASSEMBLER_HEADER_INCLUDED
#define ECS_POWERPC_ASSEMBLER_HEADER_INCLUDED
...
class ECS::PowerPC::Assembler : public Assembly::Assembler
{
public:
	Assembler (Diagnostics&, Charset&, Architecture);
...
#endif // ECS_POWERPC_ASSEMBLER_HEADER_INCLUDED
