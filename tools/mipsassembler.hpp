...
#ifndef ECS_MIPS_ASSEMBLER_HEADER_INCLUDED
#define ECS_MIPS_ASSEMBLER_HEADER_INCLUDED
...
class ECS::MIPS::Assembler : public Assembly::Assembler
{
public:
	Assembler (Diagnostics&, Charset&, Architecture, Endianness);
...
#endif // ECS_MIPS_ASSEMBLER_HEADER_INCLUDED
